...
toggleWidth() {
  ...
  const t = document.querySelector<HTMLElement>(".sidebar");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (simplebarElement) {
    ...
    // Assuming 'I' is a service or library that you've imported
    //const M = I;

    //new M(simplebarElement);ß

    const t : any= document.querySelector<HTMLElement>(".sidebar");
    const sidebarToggle:any = document.querySelector<HTMLElement>(".sidebar-toggle");
